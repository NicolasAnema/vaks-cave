...
- **Controls are locked:** arrows (incl. up/down to climb), Space jump, W meow, G burn a life for an irie rush, Enter confirm/skip cutscene, Esc pause, F fullscreen. Plus debug keys.
