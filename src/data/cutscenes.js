...
export const CUTSCENES = {
  ...
  cold_open: {
    ...
    steps: [
      ...
      ['fade', 'in', 1.4],
      ['fx', 'zzz', 2.4],
      ['note', 'THE BOTTOM OF A CAVE. THURSDAY WAS BIG.'],
      ['wait', 1.2],
      ['sprite', 'vaks', 'vaks', 'babalas'],
      ['move', 'vaks', 230, 218, 0.9],
      ['say', 'vaks', 'm_big_days'],
      ['say', 'vaks', 'WAIT. THIS IS NOT MY ROOM. THIS IS A HOLE, BOSS.'],
      ['flash', '#fff8e0', 0.4],
      ['fx', 'flashback', 0.1],
      ['say', 'vaks', 'm_going_deep'],
      ['note', 'HE DID, IN FACT, GO DEEP.'],
      ['flash', '#fff8e0', 0.4],
      ['fx', 'flashback_end', 0.1],
      ['anim', 'vaks', 'idle'],
      ['wait', 0.5],
      ['note', 'FAR ABOVE: A SPECK OF LIGHT.'],
      ['fx', 'mistStir', 1.6],
      ['shake', 1.5],
      ['note', 'BELOW HIM: THE MIST STIRS.'],
      ['say', 'vaks', 'OK. OK OK OK. WE CLIMB, BOSS. WE CLIMB NOW.'],
      ['fade', 'out', 0.9],
    ],
  },

  doubt1: {
    id: 'doubt1', name: 'DOUBT I', music: 'world1', bg: 'cave_shaft',
    actors: {
    ...
    steps: [
      ['letterbox', true],
      ['fade', 'in', 0.8],
      ['say', 'vaks', 'THAT THING IN THE MIST... IT KEEPS MISSING ME.'],
      ['move', 'tiko', 320, 246, 2.2],
      ['face', 'vaks', -1],
      ['say', 'vaks', 'IT CHASED ME PAST THE CEPPIES. PAST THE BOTTLES. EVERY TIME, BOSS.'],
      ['say', 'vaks', "ALMOST LIKE IT WAS SHOWING ME THE... NO. NO NO NO. IT'S A MONSTER."],
      ['fade', 'out', 0.7],
    ],
  },

  doubt2: {
    id: 'doubt2', name: 'DOUBT II', music: 'world1', bg: 'cave_shaft',
    actors: {
      vaks: { sheet: 'vaks', anim: 'idle', x: 230, y: 220, flip: false },
      tiko: { sheet: 'tiko_irie', anim: 'loop', x: 60, y: 200, flip: false },
    },
    steps: [
      ['letterbox', true],
      ['fade', 'in', 0.8],
      ['say', 'vaks', "THE LAZY ONE TODAY. IT JUST DRIFTED. LIKE IT WASN'T EVEN TRYING."],
      ['move', 'tiko', 120, 196, 2.0],
      ['say', 'vaks', 'AND WHY IS THERE ALWAYS GANJA EXACTLY WHERE IT HERDS ME?'],
      ['say', 'vaks', 'WHO LEAVES GANJA IN A CAVE? SOMETHING IS NOT RIGHT, BOSS.'],
      ['fade', 'out', 0.7],
    ],
  },
  ...
  boss_intro: {
    ...
    steps: [
      ['letterbox', true],
      ['fade', 'in', 0.8],
      ['note', 'THE TOP OF THE SHAFT. THE WAY OUT.'],
      ['move', 'big', 100, 238, 2.4],
      ['shake', 3],
      ['say', 'big', 'm_cat_die'],
      ['say', 'vaks', 'MY CAT?! I AM THE CAT, BOSS! MEOW!'],
      ['wait', 0.4],
      ['say', 'big', 'm_vibe'],
      ['note', 'HOLD YOUR GROUND. MATCH ITS RHYTHM.'],
      ['fade', 'out', 0.6],
    ],
  },
  ...
  boss_resolve: {
    ...
    steps: [
      ...
      ['fade', 'in', 1.2],
      ['fx', 'wind', 2.5],
      ['note', 'THE BIG TIKOLOSH SWAYS. CALM, NOW.'],
      ['say', 'vaks', 'm_wind'],
      ...
      ['move', 'big', 60, 200, 2.6],
      ['fx', 'dawn', 2.0],
      ['note', 'DAWN POURS INTO THE CAVE MOUTH.'],
      ['anim', 'vaks', 'celeb'],
      ['wait', 1.0],
      ['fade', 'out', 1.0],
    ],
  ...
  chase_begins: {
    ...
    steps: [
      ...
      ['anim', 'vaks', 'celeb'],
      ['say', 'vaks', 'SURFACE, BOSS! FRESH AIR! SUPER DAY!'],
      ['anim', 'vaks', 'idle'],
      ['say', 'vaks', 'WAIT. THE SUN IS UP. WHAT TIME IS IT? I AM SO LATE FOR WORK.'],
      ['move', 'granny', 420, 222, 1.0],
      ['anim', 'granny', 'stare'],
      ['shake', 1.5],
      ['note', 'ON THE RIDGE: GRANNY. THE STARE.'],
  ...
  ending: {
    ...
    steps: [
      ...
      ['anim', 'granny', 'stare'],
      ['wait', 1.2],
      ['note', 'GRANNY FINDS HIM HARD AT WORK. AS ALWAYS.'],
      ['anim', 'granny', 'idle'],
