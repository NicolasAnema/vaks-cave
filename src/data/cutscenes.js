...
export const CUTSCENES = {
  ...
  cold_open: {
    ...
    steps: [
      ...
      ['note', 'ONE TOO MANY ZAMALEKS LAST NIGHT BOSS...'],
      ['wait', 1.2],
      ['sprite', 'vaks', 'vaks', 'babalas'],
      ['move', 'vaks', 230, 218, 0.9],
      ['say', 'vaks', 'm_big_days'],
      ['say', 'vaks', 'WAIT. THIS IS NOT MY ROOM. WHERE AM I?'],
      ['say', 'vaks', "I'M LATE FOR WORK BOSS. GRANNY IS GONNA BE ANGRYYY."],
      ['flash', '#fff8e0', 0.4],
      ['fx', 'flashback', 0.1],
      ['wire', 'm_going_deep'],
      ...
      ['say', 'vaks', 'SHO… WE CLIMB, BOSS. WE CLIMB NOW.'],
      ['fade', 'out', 0.9],
    ],
  },
  ...
  doubt2: {
    ...
    steps: [
      ['letterbox', true],
      ['fade', 'in', 0.8],
      ['say', 'vaks', "EYTA BOSS... THIS TIKOLOSH LOOKS LIKE ME. AND HE'S IRIE TOO."],
      ['move', 'tiko', 120, 196, 2.0],
      ['say', 'vaks', 'WHY IS THERE SO MUCH GANJA IN THIS CAVE, BOSS?'],
  ...
  boss_intro: {
    ...
    steps: [
      ['letterbox', true],
      ['fade', 'in', 0.8],
      ['note', 'THE TOP OF THE CAVE. THIS IS THE WAY OUT.'],
