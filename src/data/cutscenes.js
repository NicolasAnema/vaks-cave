...
export const CUTSCENES = {
  ...
  cold_open: {
    ...
    steps: [
      ...
      ['say', 'vaks', 'WHY IS THE FLOOR... BREATHING, BOSS?'],
      ['fade', 'out', 0.9],
    ],
  },
  ...
  doubt2: {
    ...
    steps: [
      ['letterbox', true],
      ['fade', 'in', 0.8],
      ['say', 'vaks', "EYTA BOSS... THIS ONE LOOKS LIKE ME. AND HE'S IRIE TOO."],
      ['move', 'tiko', 120, 196, 2.0],
      ['say', 'vaks', 'WHY IS THERE ALWAYS GANJA IN THIS CAVE, BOSS?'],
      ['say', 'vaks', '...OH. BECAUSE I PLANTED IT HERE. SMART, BOSS. VERY SMART.'],
      ['fade', 'out', 0.7],
    ],
  },
  ...
  boss_intro: {
    ...
    steps: [
      ...
      ['shake', 3],
      ['say', 'big', 'm_cat_die'],
      ['say', 'vaks', 'm_meow_pool', 'MY CAT?! I AM THE CAT, BOSS! MEEEOOWW.'],
      ['wait', 0.4],
      ['say', 'big', 'm_vibe'],
