...
export const CUTSCENES = {
  ...
  cold_open: {
    ...
    steps: [
      ...
      ['fade', 'in', 1.4],
      ['fx', 'zzz', 2.4],
      ['note', 'VAKS SLEPT PEACEFULLY AT THE BOTTOM OF A CAVE. ONE TOO MANY ZAMALEKS LAST NIGHT BOSS...'],
      ['wait', 1.2],
      ['sprite', 'vaks', 'vaks', 'babalas'],
      ['move', 'vaks', 230, 218, 0.9],
      ['say', 'vaks', 'm_big_days'],
      ['say', 'vaks', "WAIT. THIS IS NOT MY ROOM. WHERE AM I? I'M LATE FOR WORK. GRANNY IS GONNA BE MAD BOSS"],
      ['flash', '#fff8e0', 0.4],
      ['fx', 'flashback', 0.1],
      ['wire', 'm_going_deep'],
      ['say', 'vaks', 'I CAN FEEL SOMETHING. A BLOODY TIKOLOSH.'],
      ['flash', '#fff8e0', 0.4],
  ...
  doubt1: {
    ...
    steps: [
      ['letterbox', true],
      ['fade', 'in', 0.8],
      ['say', 'vaks', "THAT TIKOLOSH... IT'S TRYNA KILL ME."],
      ['move', 'tiko', 320, 246, 2.2],
      ['face', 'vaks', -1],
      ['say', 'vaks', 'I\'M SCARED BOSS. I NEED TO GET OUT OF THIS CAVE.'],
      ['fade', 'out', 0.7],
    ],
  },
